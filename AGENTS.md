...
- **Env vars**: `ACCESS_PASSWORD`, `BLOB_READ_WRITE_TOKEN` (or `nintendo_READ_WRITE_TOKEN`)
...
- Blob consistency: Eventual consistency (~1–5 sec); client state is authoritative during session
